                        ...
                        <div className={styles.navLinks}>
                            ...
                            {prevProject && (
                                <div className={styles.navPrevious}>
                                    <Link className="button" href={`/portfolio/${prevProject.slug}/`} rel="prev" prefetch={false}>&laquo; {prevProject.title}</Link>
                                </div>
                            )}

                            {nextProject && (
                                <div className={styles.navNext}>
                                    <Link className="button" href={`/portfolio/${nextProject.slug}/`} rel="next" prefetch={false}>{nextProject.title} &raquo;</Link>
                                </div>
                            )}
